...
def admin_dashboard(request):
    # Add this debug code at the start of your view
    django_engine = engines["django"]
    print(
        "Available filters:", django_engine.engine.template_builtins[0].filters.keys()
    )
...
def admin_booking_details(request, booking_id):
    ...
    if request.method == "POST":
        ...
        if action == "update_status":
            ...
            return redirect("admin/admin-bookings")

    return render(request, "admin/admin-booking-details.html", {"booking": booking})
...
def admin_new_booking(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("admin/admin-booking-details", booking_id=booking.id)
    else:
        form = AdminBookingForm()

    return render(request, "admin/admin-new-booking.html", {"form": form})
...
def update_booking_status(request, booking_id):
    ...
    return redirect("admin/admin-booking-details", booking_id=booking_id)
